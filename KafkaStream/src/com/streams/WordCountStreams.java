...
public class WordCountStreams {
	...
	{		 
		    ...
		    streamsConfiguration.put(StreamsConfig.STATE_DIR_CONFIG, "D:\\Learning\\Library\\Apache\\Kafka\\tmp");
		    ...
		    final KStream<String, String> textLines = builder.stream("streams-test");
...
//		    final Pattern pattern = Pattern.compile("\\W+", Pattern.UNICODE_CHARACTER_CLASS);
		    ...
		    wordCounts.toStream().to("streams-test-output", Produced.with(stringSerde, longSerde));
